<template>
    <div>
         <!-- Start Hero Area -->
    <div class="hero-area style3 overlay">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="hero-text text-center">
                        ...
                        <div class="section-heading">
                            <h2 class="wow fadeInUp" data-wow-delay=".3s">Welcome to Bongo Mart</h2>
    ...
    <div class="items-tab section custom-padding">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <div class="call-action overlay section">
        <div class="container">
            <div class="row ">
